          ...
          <div className="w-full max-w-[1080px] mx-auto px-6 pt-[144px]">
            ...
            <div className="mt-3 flex flex-nowrap items-center gap-3">
              <button
                ...
                className="inline-flex h-11 items-center gap-2 rounded-full bg-primary/50 px-8 text-base font-bold text-primary-foreground hover:opacity-95 transition-all"
              >
